  ...
  setup() {
    ...
    const checkDiseasePrediction = (predictedLabel) => {
      ...
      if (predictedLabel == 'CDM') {
        ...
        Management.value = "การป้องกัน ใช้พันธุ์ข้าวโพดที่ต้นทาน ใช้สารเคมี ออติวา (ไดฟีโนโคนาโซล difenoconazole + อะซอกซีสโตรบินazoxystrobin) และการปลูกพืชหมุนเวียน";
